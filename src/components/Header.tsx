      ...
      <nav className="container mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-20">
          <a href="#" className="flex items-center group">
            <img src={logo} alt="Michael Chandler logo" className="h-16 w-auto drop-shadow-2xl brightness-110 hover:brightness-125 transition-all duration-300 group-hover:scale-110 filter hover:drop-shadow-[0_0_15px_rgba(208,165,102,0.5)]" />
          </a>
