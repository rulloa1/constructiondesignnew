...
export const Footer = () => {
  ...
  return <footer id="contact" className="py-12 border-t border-border bg-background">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-12">
            <div className="text-center group">
              ...
              <a href="mailto:mike.rcccon@yahoo.com" className="text-lg font-light hover:text-accent transition-all duration-300 hover:tracking-wide">mike.rcccon@yahoo.com</a>
            </div>
            ...
            <div className="text-center group">
              ...
              <a href="tel:+14352377373" className="text-lg font-light hover:text-accent transition-all duration-300 hover:tracking-wide">+1 (435) 237-7373</a>
            </div>
