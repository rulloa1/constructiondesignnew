...
export const Services = () => {
  ...
  return <section id="services" ref={elementRef as React.RefObject<HTMLElement>} className="relative py-20 lg:py-32 bg-foreground text-background">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-16 lg:mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="font-inter text-xs tracking-[0.3em] text-background/60 uppercase mb-3">EXPERTISE</p>
        ...
        <div ref={gridRef as React.RefObject<HTMLDivElement>} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <div key={service.title} className={`group transition-all duration-700 ${gridVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{
            transitionDelay: gridVisible ? `${200 + index * 100}ms` : '0ms'
          }}>
